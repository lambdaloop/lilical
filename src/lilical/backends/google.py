...
def run_google_oauth_sync() -> str:
    """Open the system browser, capture the loopback redirect, return creds JSON.

    Google blocks OAuth from embedded webviews, so we use the user's real
